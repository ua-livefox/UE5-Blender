...
│   │   ├── Player/                             # Материалы для персонажей игрока
│   │   └── Enemies/                            # Материалы для врагов
│   ├── Environment/                            # Материалы для окружения
│   │   ├── Nature/                             # Материалы природы
│   │   │   ├── Terrain/                        # Материалы для ландшафта (трава, земля, камни)
│   │   │   │   ├── Grass/                      # Текстуры травы
│   │   │   │   ├── Rock/                       # Текстуры камней
│   │   │   │   ├── Dirt/                       # Текстуры земли
│   │   │   │   └── Sand/                       # Текстуры песка
│   │   │   ├── Vegetation/                     # Материалы для растительности (деревья, кусты)
│   │   │   │   ├── Trees/                      # Текстуры деревьев
│   │   │   │   ├── Bushes/                     # Текстуры кустарников
│   │   │   │   └── Flowers/                    # Текстуры цветов
│   │   │   └── Water/                          # Материалы для воды (реки, озера)
│   │   ├── Buildings/                          # Материалы для зданий (кирпич, бетон)
│   │   │   └── Flooring/                       # Напольные покрытия
│   │   │       ├── Vinyl/                      # Вініл
│   │   │       ├── Wood/                       # Деревянные покрытия
│   │   │       ├── Stone/                      # Каменные покрытия
│   │   │       ├── Tile/                       # Плитка
│   │   │       └── Carpet/                     # Ковровые покрытия
│   │   ├── Streets/                            # Материалы для улиц (асфальт, плитка)
│   │   └── Sky/                                # Материалы для неба (облака, градиенты)
│   ├── Props/                                  # Материалы для пропсов
│   │   ├── Furniture/                          # Материалы для мебели (столы, стулья)
│   │   ├── Tools/                              # Материалы для инструментов (мечи, щиты)
│   │   └── Decorations/                        # Материалы для декораций (картины, скульптуры)
│   ├── Vehicles/                               # Материалы для транспортных средств
│   │   ├── Cars/                               # Материалы для автомобилей
│   │   ├── Boats/                              # Материалы для лодок
│   │   └── Airplanes/                          # Материалы для самолетов
│   ├── UI/                                     # Материалы для интерфейса
│   │   ├── Buttons/                            # Материалы для кнопок
│   │   ├── Panels/                             # Материалы для панелей
│   │   └── Icons/                              # Материалы для иконок
│   └── SpecialEffects/                         # Материалы для специальных эффектов
│       ├── Fire/                               # Материалы для огня
│       ├── Smoke/                              # Материалы для дыма
│       └── Particles/                          # Материалы для частиц (брызги, искры)
└── Animations/                                 # Анимации
